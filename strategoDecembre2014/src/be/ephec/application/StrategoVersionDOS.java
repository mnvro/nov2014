...
import be.ephec.stratego.BoiteRangement;
import be.ephec.stratego.Clavier;
import be.ephec.stratego.Damier;
import be.ephec.stratego.Deplacement;
import be.ephec.stratego.Parametres;
import be.ephec.stratego.Plateau;
import be.ephec.stratego.Triche;
...
public class StrategoVersionDOS {
	...
	public static void main(String arg[]){
		StrategoVersionDOS jeu = new StrategoVersionDOS();
