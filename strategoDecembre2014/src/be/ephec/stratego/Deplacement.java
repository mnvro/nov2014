...
public class Deplacement {
	...
	public static void bouge(StrategoVersionDOS jeu, int ligneSource, int colonneSource, int ligneDestination, int colonneDestination) {
	...
	public static ArrayList<Case> trouveToutesLesDestinationsPossibles(StrategoVersionDOS jeu, int ligneSource, int colonneSource){
