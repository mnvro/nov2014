	...
	public JPanelServeur(ApplicationServeur applicationServeur) {
		...
		JButtonEnvoyer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				applicationServeur.getServeur().ecrire(applicationServeur.getjFrameServeur().getListeNumClient().get(applicationServeur.getjFrameServeur().getComboBox().getSelectedIndex()), 
						"Le serveur a envoyé "+txtMessageEnvoyer.getText()
				);
			}
		});
